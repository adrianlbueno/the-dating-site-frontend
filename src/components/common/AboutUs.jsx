            ...
            <div className="flex justify-center items-center mainCtn h-screen about bg-gray-100 py-10 px-5">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-gray-700">
                        ...
                        time, they want to connect with others. We created Dogether to bring
                        people together. Dogs are both great companions and great
                        ...
                        Dogether we want people to feel safe, happy, and connected. We
                        create a space for people with dogs to meet, either with romantic
